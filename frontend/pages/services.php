<<<<<<< HEAD:frontend/pages/services.php
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="container">
      ...
      <section class="main">
        ...
        <div class="users">
          <div class="card">
            <img src="../banners/examinations.jpg" />
            <h4>Examinations</h4>
            <p>Dr. Amar Yousif</p>
            <div class="per">
              <table>
          ...
          <div class="card">
            <img src="../banners/medications.jpg" />
            <h4>Medications</h4>
            <p>Dr. Hassan Ahmed</p>
            <div class="per">
              <table>
          ...
          <div class="card">
            <img src="../banners/vaccinations.jpg" />
            <h4>Vaccinations</h4>
          ...
          <div class="card">
            <img src="../banners/castrations.jpg" />
            <h4>Castrations</h4>
            <p>Dr. Omar Ali</p>
            <div class="per">
              <table>
...
>>>>>>> 589f849e8cb19b3603cd8030b36c3ffb498405c6:services.php
